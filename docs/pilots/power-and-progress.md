...
The durable project currently has 70 of 3,025 active source-aligned translations and 70 matching Segment reviews. This comprises the complete 33-Segment Prologue plus all 37 Segments across the copyright/title, Contents, and Navigation/dedication Sections. Three image-only Segments use the deterministic structural passthrough without a model call. All four complete Sections have current coherence-review fingerprints and scoped validation reports zero issues.
