...
The durable project currently has 388 of 3,025 active source-aligned translations and 388 matching Segment reviews. This comprises the complete 33-Segment Prologue, all 37 Segments across the copyright/title, Contents, and Navigation/dedication Sections, all 122 Segments of Chapter 1, all 145 Segments of Chapter 2, and the first 51 Segments of Chapter 3. Three image-only Segments use the deterministic structural passthrough without a model call. All six complete Sections have current coherence-review fingerprints. Chapters 1 and 2 both pass complete Section-scoped deterministic validation with zero issues and are available as translated and bilingual Markdown/EPUB; the translated Chapter 3 scope also passes deterministic validation with zero issues but is not yet a complete Section artifact.
