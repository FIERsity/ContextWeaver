        ...
        for item in evidence:
            if "失去了力量" in item["translation"]:
                return ScopeReviewDecision(
                    "revised", ["concept_consistency"], "Use political-economic power.", 0.95,
...
def test_openai_coherence_adapter_returns_structured_revisions() -> None:
    result = {
        "verdict": "revise", "categories": ["concept_consistency"],
        "rationale": "Align the core concept.", "confidence": 0.9,
